    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-secondary/20">
      <header
        ...
        style={{
          ...
          backgroundImage: "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.7)), url('/hoian_lantern_header.webp')",
          backgroundPositionY: "20%"
        }}
      >
        <div className="mx-auto flex max-w-lg items-center justify-between gap-3 relative z-10">
          <div>
            <p className="text-xs font-bold tracking-wide text-white/80">서여사 생신기념 여행</p>
      ...
      <main className="bottom-nav-safe mx-auto max-w-lg px-4 py-5">
        {renderTab()}
        <p className="text-center text-[10px] text-muted-foreground/50 mt-8 mb-2">jihong.lee@outlook.com</p>
      </main>
